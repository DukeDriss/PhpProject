...
if(isset($_POST['nom'])){
  ...
  $tel= $_POST['tel'];
  $ville= $_POST['ville'];
$query = "UPDATE `equipe` SET `NomEquipe` = '$nom', `Stade` = '$stade', `logo` = '$logo', `adresse` = '$adresse', `email` = '$email', `site` = '$site', `tel` = '$tel', `fax` = '$fax', `ville` = '$ville' WHERE `equipe`.`CodeEquipe` = '$id' ";
    ...
    <section class="content container-fluid">
      <form method="post" target="equipe-edit.php">
          <table class="table table-inverse">
            ...
            <tr>  <th>Date Creation</th><td><input type="text" name="date" ></td>  </tr>
