...
if(isset($_POST['sujet'])){
  ...
  $video= $_POST['video'];
  $date= $_POST['date'];
$query = "UPDATE `news` SET `sujet` = '$sujet', `auteur` = '$auteur', `text` = '$text', `photo` = '$photo', `video` = '$video', `Datepublication` = '$date' WHERE `news`.`id` = '$id' ";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      <form method="post" target="news-edit.php">
